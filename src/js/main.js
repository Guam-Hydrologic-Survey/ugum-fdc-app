...
fetch('./src/data/STREAM_GAGES_USED.json')
  ...
  .then(geojson => {
    const getInfo = (feature, layer) => {
        ...
        layer.bindPopup(`<span align="center"><b>${feature.properties.AGENCY}</b> <br>Stream Gage #: ${feature.properties.GAGE_NUMBE} <br><i><a href=${feature.properties.USGS_link} >${feature.properties.NAME}</i></a></span>`);
    }
